...
public class TPostController {
	...
	public String createTPost(@PathVariable Integer teamId, TPostCreateDto dto,
		...
		// TODO 업로드할 이미지가 있을 경우 실행할 이미지 저장 서비스
		// 서버에 저장될 저장 위치
	...
	public String list(@PathVariable Integer teamId, Model model) {
		...
		List<TPost> posts = postService.read();
	...
	public String details(@PathVariable Integer teamId, @PathVariable Integer id, Model model, HttpServletRequest request) {
